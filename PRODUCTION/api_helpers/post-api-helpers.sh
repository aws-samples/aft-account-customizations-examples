...
cidr_block=`aws ssm get-parameter --name "/$accountnumber/vpc/cidr"  --query Parameter.Value --output text`
...
jinja_json="{\"environment\":\"prd\",\"workloadAccount\":\"$accountnumber\"}"
aws ssm put-parameter --name "/prd/terraform-parameters/jinja" --value $jinja_json --type "String" --overwrite